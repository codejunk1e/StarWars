...
import com.project.valhallastudio.starwars.adapters.resources.SpeciesAdapter
...
class SpeciesFragment() : Fragment() {
    private val resourceAdapter = SpeciesAdapter()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragment?.viewLifecycleOwner?.let {
            viewModel.speciesPagedList.observe(it, Observer {
